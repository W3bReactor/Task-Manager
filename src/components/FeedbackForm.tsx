...
const FeedbackForm = () => {
	...
	function sendEmail(object: FormikValues) {
		const params = { ...object, 'g-recaptcha-response': recaptcha };
		emailjs
			.send('service_drthjag', 'template_ylwlrub', params, 'WG8okJXeNddhbGn_p')
			.then(
				(result) => {
			...
			>
				{({ errors, touched, isSubmitting }) => (
					<SettingsForm>
						...
						/>
						<Captcha
							sitekey="6Lfqd_EmAAAAAKJVqH4IExBc17PRiY3IiLqAxXLX"
